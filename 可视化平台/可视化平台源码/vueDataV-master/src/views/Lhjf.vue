            ...
            <div class="content">
                <item>
                    ...
                    <template v-slot:chart>
                        <!--最近五年案件量 柱状图-->
                        <bars api="/lhjf/getAjCount" :begin-time="beginTime" :end-time="endTime" title="案件审结情况"/>
                    </template>
                </item>
              <item>
                <template v-slot:title>案件审理情况</template>
                <template v-slot:chart>
                  <three-bars api="/lhjf/getAjsl" :begin-time="beginTime" :end-time="endTime" title1="案件审理情况"/>
                </template>
              </item>
              <item>
                <template v-slot:title>部门审理情况（立案数）</template>
                <template v-slot:chart>
                  <three-bars-without-des api="/lhjf/getBmslLa" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
                </template>
              </item>
              <item>
                <template v-slot:title>部门审理情况（结案数）</template>
                <template v-slot:chart>
                  <three-bars-without-des api="/lhjf/getBmslJa" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
                </template>
              </item>
              <item>
                <template v-slot:title>部门审理情况（平均审理天数）</template>
                <template v-slot:chart>
                  <three-bars-without-des api="/lhjf/getBmslAvg" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
                </template>
              </item>
                <item>
                    ...
                    <template v-slot:chart>
                        <!--天津各地区案件量分布 柱状图-->
                        <tianjin-map api="/lhjf/getAreaDistribution" :begin-time="beginTime" :end-time="endTime" title="被告人特征"/>
                    </template>
                </item>
              <item>
                ...
                <template v-slot:chart>
                  <!--受教育水平 文化程度 柱状图-->
                  <three-bars api="/lhjf/getDsrAge" :begin-time="beginTime" :end-time="endTime" title="被告人特征"/>
                </template>
              </item>
                <item>
                    ...
                    <template v-slot:chart>
                        <!--受教育水平 文化程度 柱状图-->
                        <three-bars api="/lhjf/getWhcd" :begin-time="beginTime" :end-time="endTime" title="被告人特征"/>
                    </template>
                </item>
                <item>
                    ...
                    <template v-slot:chart>
                        <!--判决结果 环状图-->
                        <three-bars api="/lhjf/getPjjg" :begin-time="beginTime" :end-time="endTime" title="被告人特征"/>
                    </template>
                </item>
            </div>
        </div>
