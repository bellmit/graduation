      ...
      <div class="content">
        <item>
          ...
          <template v-slot:chart>
            <!--最近五年案件量 柱状图-->
            <bars api="/dxwlzp/getAjCount" :begin-time="beginTime" :end-time="endTime" title="案件审结情况"/>
          </template>
        </item>
        <item>
          <template v-slot:title>案件审理情况</template>
          <template v-slot:chart>
            <three-bars api="/dxwlzp/getAjsl" :begin-time="beginTime" :end-time="endTime" title1="案件审理情况"/>
          </template>
        </item>
        <item>
          <template v-slot:title>部门审理情况（立案数）</template>
          <template v-slot:chart>
            <three-bars-without-des api="/dxwlzp/getBmslLa" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
          </template>
        </item>
        <item>
          <template v-slot:title>部门审理情况（结案数）</template>
          <template v-slot:chart>
            <three-bars-without-des api="/dxwlzp/getBmslJa" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
          </template>
        </item>
        <item>
          <template v-slot:title>部门审理情况（平均审理天数）</template>
          <template v-slot:chart>
            <three-bars-without-des api="/dxwlzp/getBmslAvg" :begin-time="beginTime" :end-time="endTime" title1="部门审理情况"/>
          </template>
        </item>
        <item>
          ...
          <template v-slot:chart>
            <!--被告人性别-->
            <three-bars api="/dxwlzp/getBgxb" :begin-time="beginTime" :end-time="endTime" title="被告人特征（性别）"/>
          </template>
        </item>
        <item>
          ...
          <template v-slot:chart>
            <!--被告人年龄-->
            <three-bars api="/dxwlzp/getBgAge" :begin-time="beginTime" :end-time="endTime" title="被告人特征（年龄）"/>
          </template>
        </item>
        <item>
          ...
          <template v-slot:chart>
            <!--被告人身份-->
            <three-bars api="/dxwlzp/getBgWhcd" :begin-time="beginTime" :end-time="endTime" title="被告人特征（文化程度）"/>
          </template>
        </item>
        <item>
          ...
          <template v-slot:chart>
            <!--被告人身份-->
            <three-bars api="/dxwlzp/getBgSf" :begin-time="beginTime" :end-time="endTime" title="被告人特征（身份）"/>
          </template>
        </item>
        <item>
          <template v-slot:title>被告规模</template>
          <template v-slot:chart>
            <three-bars api="/dxwlzp/getBgNum" :begin-time="beginTime" :end-time="endTime" title=""/>
          </template>
        </item>
      </div>
    </div>
...
<script>
import {screenSize, getCurTime, nextMonth} from '@/assets/js/utils'
  import '@/utils/export'
  export default {
    name: 'Home',
    components: {},
